...
public class MainActivity extends AppCompatActivity implements ServiceConnection {
    ...
    private void initView() {
        userPhone = (EditText) findViewById(R.id.driver_phone);
        userName = (EditText) findViewById(R.id.user_name);

        takeTaxi = (Button) findViewById(R.id.take_taxi);
        takeTaxi.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        public void handleMessage(Message msg) {
            ...
            if (server_msg.equals("@error")) {
                ...
                try {
                    ...
                    userInfo.put(ClientUtil.JSON_USER_TYPE, ClientUtil.TAKE_TAXI_USER);
